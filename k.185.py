...
def prime():
    ...
    for i in range(1,n+1):
        if n%i==0:
            count=count+1
    if count==2:
        result.configure(text='Prime number:')
    else:
        result.configure(text='Not Prime number ')
    t2.insert(0,count)
# Label for design
...
# Button design
b1 = Button(w1, text="Prime", bg="Orange", fg="red", command=prime)
# Label for design
l2 = Label(w1, text=" count : ", font=("Arial Bold", 10))
